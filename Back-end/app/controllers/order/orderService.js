...
const { cart: Cart, order: Order, orderItem: OrderItem,cartItem: CartItem } = db;
...
const { validateID, 
    ...
    validateCart } = require('../../validators/validatorUtils');

require('dotenv').config();
const stripe = 'sk_test_26PHem9AhJZvU623DfE1x4sd'
